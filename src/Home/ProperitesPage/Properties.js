    ...
    <div className="container">
      ...
      <div className="row properties-box">
        <div className="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
          <div className="item">
            <a href="property-details.html"><img src="assNclassNameets/images/property-01.jpg" alt=""/></a>
        ...
        <div className="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 str">
          <div className="item">
            <a href="property-details.html"><img src="assNclassNameets/images/property-02.jpg" alt=""/></a>
            <span className="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
        ...
        <div className="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv rac">
          <div className="item">
            <a href="property-details.html"><img src="assNclassNameets/images/property-03.jpg" alt=""/></a>
            <span className="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
        ...
        <div className="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 str">
          <div className="item">
            <a href="property-details.html"><img src="assNclassNameets/images/property-04.jpg" alt=""/></a>
        ...
        <div className="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 rac str">
          <div className="item">
            <a href="property-details.html"><img src="assNclassNameets/images/property-05.jpg" alt=""/></a>
        ...
        <div className="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 rac adv">
          <div className="item">
            <a href="property-details.html"><img src="assNclassNameets/images/property-06.jpg" alt=""/></a>
