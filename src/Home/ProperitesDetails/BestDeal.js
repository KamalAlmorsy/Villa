              ...
              <div className="tab-content" id="myTabContent">
                    ...
                    <div className="col-lg-3">
                      <div className="info-table">
                        <ul>
                          ...
                          <li>Payment ProcessNclassName <span>Bank</span></li>
                        </ul>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <img src="assNclassNameets/images/deal-01.jpg" alt=""/>
                    </div>
                    <div className="col-lg-3">
                      <h4>All Info About Apartment</h4>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, do eiusmod tempor pack incididunt ut labore et dolore magna aliqua quised ipsum suspendissNclassNamee. <br/><br/>Swag fanny pack lyft blog twee. JOMO ethical copper mug, succulents typewriter shaman DIY kitsch twee taiyaki fixie hella venmo after messNclassNameenger poutine next level humblebr/ag swag franzen.</p>
                ...
                <div className="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assNclassNameets/images/deal-02.jpg" alt=""/>
                    </div>
                    <div className="col-lg-3">
                ...
                <div className="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assNclassNameets/images/deal-03.jpg" alt=""/>
                    </div>
                    <div className="col-lg-3">
