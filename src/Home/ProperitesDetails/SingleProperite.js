      ...
      <div className="row">
        <div className="col-lg-8">
          <div className="main-image">
            <img src="assnclassNameets/images/single-property.jpg" alt=""/>
          </div>
        ...
        <div className="col-lg-4">
          <div className="info-table">
            <ul>
              <li>
                <img src="assnclassNameets/images/info-icon-01.png" alt="" className="img-new"/>
                <h4>450 m2<br/><span>Total Flat Space</span></h4>
              </li>
              <li>
                <img src="assnclassNameets/images/info-icon-02.png" alt="" className="img-new"/>
                <h4>Contract<br/><span>Contract Ready</span></h4>
              </li>
              <li>
                <img src="assnclassNameets/images/info-icon-03.png" alt="" className="img-new"/>
                <h4>Payment<br/><span>Payment Process</span></h4>
              </li>
              <li>
                <img src="assnclassNameets/images/info-icon-04.png" alt="" className="img-new"/>
...
export default SingleProperite